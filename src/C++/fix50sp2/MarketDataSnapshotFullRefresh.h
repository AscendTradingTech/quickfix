...
namespace FIX50SP2
{
  ...
  public:
    ...
    MarketDataSnapshotFullRefresh(
      const FIX::LastUpdateTime& aLastUpdateTime )
    : Message(MsgType())
    {
      set(aLastUpdateTime);
    }
    ...
    FIELD_SET(*this, FIX::CommodityFinalPriceType);
    FIELD_SET(*this, FIX::NoIndexRollMonths);
    class NoIndexRollMonths: public FIX::Group
    {
    public:
    NoIndexRollMonths() : FIX::Group(2734,2733,FIX::message_order(2733,0)) {}
      FIELD_SET(*this, FIX::IndexRollMonth);
    };
    FIELD_SET(*this, FIX::NextIndexRollDate);
    FIELD_SET(*this, FIX::FloatingRateIndexID);
    FIELD_SET(*this, FIX::FloatingRateIndexIDSource);
    FIELD_SET(*this, FIX::FloatingRateIndexCurveUnit);
    FIELD_SET(*this, FIX::FloatingRateIndexCurvePeriod);
    FIELD_SET(*this, FIX::FloatingRateIndexCurveSpread);
    FIELD_SET(*this, FIX::NoReferenceDataDates);
    class NoReferenceDataDates: public FIX::Group
    {
    public:
    NoReferenceDataDates() : FIX::Group(2746,2747,FIX::message_order(2747,2748,0)) {}
      FIELD_SET(*this, FIX::ReferenceDataDate);
      FIELD_SET(*this, FIX::ReferenceDataDateType);
    };
    FIELD_SET(*this, FIX::AgreementDesc);
    FIELD_SET(*this, FIX::AgreementID);
    FIELD_SET(*this, FIX::AgreementVersion);
    FIELD_SET(*this, FIX::AgreementDate);
    FIELD_SET(*this, FIX::AgreementCurrency);
    FIELD_SET(*this, FIX::AgreementCurrencyCodeSource);
    FIELD_SET(*this, FIX::MasterConfirmationDesc);
    FIELD_SET(*this, FIX::MasterConfirmationDate);
    FIELD_SET(*this, FIX::MasterConfirmationAnnexDesc);
    FIELD_SET(*this, FIX::MasterConfirmationAnnexDate);
    FIELD_SET(*this, FIX::BrokerConfirmationDesc);
    FIELD_SET(*this, FIX::NoContractualDefinitions);
    class NoContractualDefinitions: public FIX::Group
    {
    public:
    NoContractualDefinitions() : FIX::Group(40040,40041,FIX::message_order(40041,0)) {}
      FIELD_SET(*this, FIX::ContractualDefinition);
    };
    FIELD_SET(*this, FIX::NoFinancingTermSupplements);
    class NoFinancingTermSupplements: public FIX::Group
    {
    public:
    NoFinancingTermSupplements() : FIX::Group(40046,40047,FIX::message_order(40047,40048,0)) {}
      FIELD_SET(*this, FIX::FinancingTermSupplementDesc);
      FIELD_SET(*this, FIX::FinancingTermSupplementDate);
    };
    FIELD_SET(*this, FIX::NoContractualMatrices);
    class NoContractualMatrices: public FIX::Group
    {
    public:
    NoContractualMatrices() : FIX::Group(40042,40043,FIX::message_order(40043,40044,40045,0)) {}
      FIELD_SET(*this, FIX::ContractualMatrixSource);
      FIELD_SET(*this, FIX::ContractualMatrixDate);
      FIELD_SET(*this, FIX::ContractualMatrixTerm);
    };
    FIELD_SET(*this, FIX::CreditSupportAgreementDesc);
    FIELD_SET(*this, FIX::CreditSupportAgreementDate);
    FIELD_SET(*this, FIX::CreditSupportAgreementID);
    FIELD_SET(*this, FIX::GoverningLaw);
    FIELD_SET(*this, FIX::DocumentationText);
    FIELD_SET(*this, FIX::EncodedDocumentationTextLen);
    FIELD_SET(*this, FIX::EncodedDocumentationText);
    ...
    FIELD_SET(*this, FIX::NoRelatedInstruments);
    class NoRelatedInstruments: public FIX::Group
    {
    public:
    NoRelatedInstruments() : FIX::Group(1647,1648,FIX::message_order(1648,1649,1650,1651,1652,1653,2413,2414,2415,2417,0)) {}
      FIELD_SET(*this, FIX::RelatedInstrumentType);
      FIELD_SET(*this, FIX::RelatedSymbol);
      FIELD_SET(*this, FIX::RelatedSecurityID);
      FIELD_SET(*this, FIX::RelatedSecurityIDSource);
      FIELD_SET(*this, FIX::RelatedSecurityType);
      FIELD_SET(*this, FIX::RelatedMaturityMonthYear);
      FIELD_SET(*this, FIX::RelatedToSecurityID);
      FIELD_SET(*this, FIX::RelatedToSecurityIDSource);
      FIELD_SET(*this, FIX::RelatedToStreamXIDRef);
      FIELD_SET(*this, FIX::RelatedToDividendPeriodXIDRef);
    };
    ...
    FIELD_SET(*this, FIX::MDSecurityTradingStatus);
    FIELD_SET(*this, FIX::MDHaltReason);
    FIELD_SET(*this, FIX::NoMDEntries);
    class NoMDEntries: public FIX::Group
    {
    public:
    NoMDEntries() : FIX::Group(268,269,FIX::message_order(269,278,270,423,2709,819,235,236,701,696,697,698,218,220,2950,221,222,662,663,699,761,40,15,2897,120,2899,1445,271,1177,1093,272,273,274,275,336,625,326,327,2447,2705,276,277,1838,2961,2667,282,283,284,286,59,432,126,1629,1916,110,18,287,37,198,299,1003,1851,288,289,2449,2450,346,290,546,811,828,829,855,2896,1934,2963,2405,574,1115,1390,2668,2373,570,1855,58,354,355,1023,528,1024,332,333,1025,31,1592,1020,1306,1148,1149,1150,1143,731,2451,63,64,1070,83,1048,1026,1027,453,2445,2446,654,0)) {}
      FIELD_SET(*this, FIX::MDEntryType);
      FIELD_SET(*this, FIX::MDEntryID);
      FIELD_SET(*this, FIX::MDEntryPx);
      FIELD_SET(*this, FIX::PriceType);
      FIELD_SET(*this, FIX::NoPriceQualifiers);
      class NoPriceQualifiers: public FIX::Group
      {
      public:
      NoPriceQualifiers() : FIX::Group(2709,2710,FIX::message_order(2710,0)) {}
        FIELD_SET(*this, FIX::PriceQualifier);
      };
      ...
      FIELD_SET(*this, FIX::BenchmarkCurveCurrencyCodeSource);
      ...
      {
      public:
      NoRateSources() : FIX::Group(1445,1446,FIX::message_order(1446,1447,1448,2412,2796,0)) {}
        FIELD_SET(*this, FIX::RateSource);
        FIELD_SET(*this, FIX::RateSourceType);
        FIELD_SET(*this, FIX::ReferencePage);
        FIELD_SET(*this, FIX::RateSourceReferemcePageHeading);
        FIELD_SET(*this, FIX::FXBenchmarkRateFix);
      };
      ...
      FIELD_SET(*this, FIX::MarketCondition);
      FIELD_SET(*this, FIX::QuoteCondition);
      FIELD_SET(*this, FIX::TradeCondition);
      FIELD_SET(*this, FIX::NoTradePriceConditions);
      class NoTradePriceConditions: public FIX::Group
      {
      public:
      NoTradePriceConditions() : FIX::Group(1838,1839,FIX::message_order(1839,0)) {}
        FIELD_SET(*this, FIX::TradePriceCondition);
      };
      FIELD_SET(*this, FIX::AnonymousTradeIndicator);
      FIELD_SET(*this, FIX::AlgorithmicTradeIndicator);
      ...
      FIELD_SET(*this, FIX::ExposureDuration);
      FIELD_SET(*this, FIX::ExposureDurationUnit);
      ...
      FIELD_SET(*this, FIX::StrategyLinkID);
      FIELD_SET(*this, FIX::MDEntryBuyer);
      FIELD_SET(*this, FIX::MDEntrySeller);
      FIELD_SET(*this, FIX::NumberOfBuyOrders);
      FIELD_SET(*this, FIX::NumberOfSellOrders);
      ...
      FIELD_SET(*this, FIX::TertiaryTrdType);
      FIELD_SET(*this, FIX::RegulatoryReportType);
      FIELD_SET(*this, FIX::MultiJurisdictionReportingIndicator);
      FIELD_SET(*this, FIX::ExecMethod);
      FIELD_SET(*this, FIX::MatchType);
      FIELD_SET(*this, FIX::OrderCategory);
      FIELD_SET(*this, FIX::TradePublishIndicator);
      FIELD_SET(*this, FIX::NoTrdRegPublications);
      class NoTrdRegPublications: public FIX::Group
      {
      public:
      NoTrdRegPublications() : FIX::Group(2668,2669,FIX::message_order(2669,2670,0)) {}
        FIELD_SET(*this, FIX::TrdRegPublicationType);
        FIELD_SET(*this, FIX::TrdRegPublicationReason);
      };
      ...
      NoRelatedTrades() : FIX::Group(1855,1856,FIX::message_order(1856,1857,2103,1858,1859,1860,0)) {}
        ...
        FIELD_SET(*this, FIX::RelatedTradeDate);
        FIELD_SET(*this, FIX::RelatedTradeMarketID);
        FIELD_SET(*this, FIX::RelatedTradeQuantity);
      };
      ...
      FIELD_SET(*this, FIX::DiscountFactor);
      ...
      FIELD_SET(*this, FIX::SettlPriceDeterminationMethod);
      ...
      FIELD_SET(*this, FIX::AggressorTime);
